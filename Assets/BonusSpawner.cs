...
public class BonusSpawner : MonoBehaviour
{
    ...
    void SpawnTriangles()
    {
        spawnObstaclePosition = new Vector3(Random.Range(-5, 5), 0.1f, spawnObstaclePosition.z + Random.Range(100,300));
        Instantiate(trianglePrefabs[(Random.Range(0, trianglePrefabs.Length))], spawnObstaclePosition, Quaternion.Euler(0, Random.Range(0f, 360f), 0),bonuses.transform);
    }
}
